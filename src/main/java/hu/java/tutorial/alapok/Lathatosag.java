...
public class Lathatosag {
  ...
  //csak ebben az osztályban, és az ebből az osztályból leszármazó osztályokban látható. ill. az ugyanabban a package-ben lévő osztályokban
  protected String b;
  ...
  //final - konstans változók definiálására (az értéke később nem változtatható meg), (nem származtatható belőle osztály, illetve nem lehet felülírni a metódust)
  //abstract - abstract osztályok/metódusok létrehozására
  //synchronized - szálkezelésnél számít
  //volatile - szálkezelésnél használadnó
  //transient - szerializáció
}
